...
<body data-spy="scroll" data-target=".navbar" data-offset="120" >
    ...
    <div id="menu" class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
            <div class="navbar-header visible-xs">
                ...
                <a class="navbar-brand" href="/"><h2>Sentosa Beef</h2></a>
            </div><!-- navbar-header -->
    ...
    <div id="header">
        ...
        <div class="center text-center">
            <div class="banner">
                <h1 class="">SENTOSA BEEF</h1>
            </div>
            <div class="subtitle"><h4>TOP QUALITY BEEF</h4></div>
        </div>
    ...
    <div id="facts" class="parallax parallax2 facts">
        ...
        <div class="container inner">
            ...
            <div class="row text-center services-3">
                <div class="col-sm-4">
                    <div class="col-wrapper">
                    <div class="icon-border bm10"> <i class="fa fa-beer" style="color: black;"></i> </div>
                    <h4 style="color: black;">Cow Meat</h4>
                    <p style="color: black;"></p>
                </div>
            </div>
            <div class="col-sm-4">
                <div class="col-wrapper">
                    <div class="icon-border bm10"> <i class="fa fa-play-circle-o" style="color: black;"></i> </div>
                    <h4 style="color: black;">Goat Meat</h4>
                
                </div>
            </div>
            <div class="col-sm-4">
                <div class="col-wrapper">
                    <div class="icon-border bm10"> <i class="fa fa-truck" style="color: black;"></i> </div>
                    <h4 style="color: black;">Chicken Meat</h4>
